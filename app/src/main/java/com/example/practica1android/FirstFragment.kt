...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mexicanImageView.setOnClickListener {
            Toast.makeText(binding.root.context, R.string.mexican_order, Toast.LENGTH_SHORT).show()
        }

        binding.cheeseImageView.setOnClickListener {
            Toast.makeText(binding.root.context, R.string.cheese_order, Toast.LENGTH_SHORT).show()
        }
    }
